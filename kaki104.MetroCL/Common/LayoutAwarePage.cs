...
namespace kaki104.MetroCL.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        public LayoutAwarePage()
        {
            ...
            //var color = kaki104.MetroCL.Statics.Functions.FromKnownColor("white");
            //this.Background = new Windows.UI.Xaml.Media.SolidColorBrush(color);
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            else
            {
                ...
                // from cache
                var pageState = (Dictionary<String, Object>)frameState[this._pageKey];
                //네비게이션 모드 추가
                pageState["NavigationMode"] = e.NavigationMode.ToString();
                this.LoadState(e.Parameter, pageState);
            }
        }
